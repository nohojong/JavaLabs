...
import com.nhj.classes.nestedClasses.DefiningInnerAndStaticClassOuterClass.StaticNestedClass;
//import com.nhj.classes.nestedClasses.OuterClass.InnerClass;

//동이한 패키지에 있지만, 내부 클래스로 정의된 클래스는 import 해야한다.
public class Main {
	...
	public static void testAllNestedClasses() {
        ...
        // Inner[non-static nested] class 의 인스턴스를 만드는 방법
        // 무조건 Outer class의 인스턴스 작업이 선행되어야함
        ...
        // 그냥 outer class가 위치한 패키지에 별도로 정의하는것이 나을지도 모른다
        ...
        // 교재에서 일컫는 최상의 레벨의 클래스라는 것은.
        // 단순히, 중첩 클래스 관점에서 보면...
        // 일반적은 클래스 또는 중첩 클래스를 정의 한 클래스임!!
